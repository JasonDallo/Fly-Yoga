...
class Course
{
     ...
     * Set placesUtilisées
     *
     * @param integer $placesUtilisées
     *
     * @return Course
     */
    public function setPlacesUtilisées($placesUtilisées)
    {
        $this->placesUtilisées = $placesUtilisées;
     ...
     * @return integer
     */
    public function getPlacesUtilisées()
    {
        return $this->placesUtilisées;
    }
}
